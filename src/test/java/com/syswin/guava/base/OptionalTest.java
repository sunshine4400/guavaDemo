...
public class OptionalTest extends TestCase{
	 ...
	 */
	public void test1(){
		 Optional<ObjectsTest.Student> possibleNull = Optional.of(null);
	     possibleNull.get();
	}

	public void test2(){
		 Optional<ObjectsTest.Student> possibleNull = Optional.absent();
	     ObjectsTest.Student jim = possibleNull.get();
	}
